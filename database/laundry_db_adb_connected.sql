...
-- =============================================
-- Added Foreign Key Connections (No Structural Changes)
-- =============================================

-- Connect laundry_list to customers
ALTER TABLE `laundry_list`
ADD COLUMN `customer_id` INT(11) NULL AFTER `id`,
ADD CONSTRAINT `fk_laundry_customer`
  FOREIGN KEY (`customer_id`) REFERENCES `customers`(`id`) ON DELETE SET NULL;

-- Connect laundry_items to laundry_list
ALTER TABLE `laundry_items`
ADD CONSTRAINT `fk_laundry_items_laundry`
  FOREIGN KEY (`laundry_id`) REFERENCES `laundry_list`(`id`) ON DELETE CASCADE;

-- Connect expenditures to users
ALTER TABLE `expenditures`
ADD COLUMN `user_id` INT(11) NULL AFTER `id`,
ADD CONSTRAINT `fk_expenditures_user`
